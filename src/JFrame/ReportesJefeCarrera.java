 ...
 * @author Camilo-PC
 */
public class ReportesJefeCarrera extends javax.swing.JFrame {

    /**
     * Creates new form ReportesJefeCarrera
     */
    public ReportesJefeCarrera() {
        initComponents();
        llenarComboSede();
        llenarComboCarrera();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportesJefeCarrera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportesJefeCarrera().setVisible(true);
            }
        });
    }
