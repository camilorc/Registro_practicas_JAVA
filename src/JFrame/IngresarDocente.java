...
public class IngresarDocente extends javax.swing.JFrame {
    ...
    private void jb_crearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jb_crearActionPerformed
        ...
        try {
            ...
            docente.setRut(Integer.parseInt(jt_rut.getText()));
            docente.setDv(jt_dv.getText());
            //Usamos método para auto generar
            docente.setPass(jt_pass.getText());
            docente.setNombres(jt_nombres.getText());
            docente.setApellido1(jt_primer_apellido.getText());
            docente.setApellido2(jt_segundo_apellido.getText());
            docente.setFecha_nacimiento(fecha);
            docente.setDireccion(jt_direccion.getText());
            docente.setTelefono(Integer.parseInt(jt_fono.getText()));
            docente.setEmail(jt_email.getText());
            docente.setId_practica(0);
            docente.setId_rol(3);
            docente.setId_sede(sede.getIdSede());
            docente.setNombre_sede(sede.getNombreSede());
            docente.setId_carrera(carrera.getIdCarrera());
            docente.setNombre_carrera(carrera.getNombreCarrera());

            if (docente.Create()) {
                jl_mensaje1.setText("Docente Creado");
                limpiarFormulario();
            } else {
                jl_mensaje1.setText("Error al crear al Docente");
            }
    ...
    private void btn_buscatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscatActionPerformed
        ...
        try {
            ...
            if (docente.Buscar(3)) {
                jt_dv.setText(docente.getDv());
                jt_pass.setText(docente.getPass());
                jt_nombres.setText(docente.getNombres());
                jt_primer_apellido.setText(docente.getApellido1());
                jt_segundo_apellido.setText(docente.getApellido2());
                txtDia.setText(docente.getFecha_nacimiento().substring(1, 2));
                txtMes.setText(docente.getFecha_nacimiento().substring(3, 4));
                txtAnio.setText(docente.getFecha_nacimiento().substring(5, 8));
                jt_direccion.setText(docente.getDireccion());
                jt_fono.setText(Integer.toString(docente.getTelefono()));
                jt_email.setText(docente.getEmail());
                jl_mensaje1.setText("Docente encontrado");
            } else {
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        ...
        try {
            ...
            if (docente.Delete()) {
                limpiarFormulario();
                jl_mensaje1.setText("Docente Eliminado");
            } else {
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        ...
        try {
            ...
            if (docente.Update()) {
                jl_mensaje1.setText("Docente Actualizado");
            } else {
