...
public class BuscarSede extends javax.swing.JFrame {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            ...
            Sede escuelas = esc.BuscarSede(nombre);
            System.out.println("knk");
            if (!escuelas.equals(" ")) {
                txt_Resultado.append(escuelas.toString());
            } else {
                JOptionPane.showMessageDialog(null, "no se encontro", "ERROR", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "se fue a catch de buscar", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
