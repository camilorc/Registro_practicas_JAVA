 ...
 * @author Camilo-PC
 */
public class ReportesJefeCarreraEspecifico extends javax.swing.JFrame {

    /**
     * Creates new form ReportesJefeCarrera
     */
    public ReportesJefeCarreraEspecifico() {
        initComponents();
        llenarComboSede();
        llenarComboCarrera();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportesJefeCarreraEspecifico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportesJefeCarreraEspecifico().setVisible(true);
            }
        });
    }
